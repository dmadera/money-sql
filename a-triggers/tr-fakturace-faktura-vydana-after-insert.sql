CREATE OR ALTER TRIGGER USER_Fakturace_FakturaVydana_AfterInsert
...
BEGIN
	...
	INNER JOIN Adresar_FirmaAdresniKlic AS FirAdrKl ON FirAdrKl.Parent_ID = D.Firma_ID
	...
	INNER JOIN inserted ON inserted.CisloDokladu = ID.ParovaciSymbol OR inserted.PuvodniDoklad = ID.ParovaciSymbol;
