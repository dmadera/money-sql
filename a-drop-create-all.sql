...
GO
:r \\tsclient\_home_dmadera\projects\money-sql\a-drop-all.sql
GO
PRINT 'Creating objects from dir ./a-types.';
GO
:r \\tsclient\_home_dmadera\projects\money-sql\a-types\type-user-mnozstvi-v-jednotkach.sql
GO
:r \\tsclient\_home_dmadera\projects\money-sql\a-types\type-user-polozka-dokladu.sql
GO
...
GO
:r \\tsclient\_home_dmadera\projects\money-sql\a-views\view-user-posledni-prijmy-zasoby.sql
GO
:r \\tsclient\_home_dmadera\projects\money-sql\a-views\view-user-zasoby.sql
GO
PRINT 'Creating objects from dir ./a-procedures.';
GO
:r \\tsclient\_home_dmadera\projects\money-sql\a-procedures\proc-user-import-fa-do-pohody.sql
GO
:r \\tsclient\_home_dmadera\projects\money-sql\a-procedures\proc-user-mnozstvi-artiklu-v-jednotkach.sql
GO
...
GO
:r \\tsclient\_home_dmadera\projects\money-sql\a-triggers\tr-objednavky-polozka-nabidky-vydane-after-insert-update.sql
GO
:r \\tsclient\_home_dmadera\projects\money-sql\a-triggers\tr-objednavky-polozka-objednavky-prijate-after-insert-update.sql
GO
...
GO
:r \\tsclient\_home_dmadera\projects\money-sql\a-triggers\tr-ucetnictvi-interni-doklad-after-insert-update.sql
GO
